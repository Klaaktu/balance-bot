...
\subsection{Budget}
This project has light budget requirements. The robot is assembled using off-the-shelf components and programmed using free and open-source libraries. A copy of the parts was provided to us, but they can be acquired online for about \$130 AUD. The cost of 3D printing the prototype chassis was less than $5 AUD.
